...
loopCode = loopCode.replace(
    'TECH_TREE[researchingId].effect(myRole);', 
    'TECH_TREE[researchingId].effect(myRole, structs);'
);
loopCode = loopCode.replace(
    "TECH_TREE[eResearchingId].effect('enemy');",
    "TECH_TREE[eResearchingId].effect('enemy', structs);"
);
